  ...
  const posts = [
    {
      ...
      slug: "welcome-to-ogt",
      excerpt:
        "Discover the mission and values of OGT Store, your destination for premium wellness and pleasure products.",
      content:
    ...
    },
    {
      ...
      excerpt:
        "Start your year right with our top wellness tips for a better intimate life.",
      content:
        "As we move into 2024, it's important to prioritize self-care and intimate wellness...",
      category: "guides",
      published_at: new Date(),
    },
  ];
